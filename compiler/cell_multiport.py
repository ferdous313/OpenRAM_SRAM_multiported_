...
class cell_multiport(design.design):
    ...
    def create_layout(self):
        ...
        #self.extend_wells()
        self.extend_active()
        #limaself.connect_sources_access_nmos_lima()
        #limaself.connect_wordline_bitline_lima()      
        #limaself.route_output_gate_WordLine1_lima()
    ...
    def create_ptx_lima(self):
        ...
        """#limaself.nmos3 = ptx(width=self.nmos_size,
                         mults=self.tx_mults,
                         tx_type="nmos")
