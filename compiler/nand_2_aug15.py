...
class nand_2(design.design):
    ...
    def add_rails(self):
        ...
        # Relocate the origin
        self.gnd_position = vector(0, - 17*drc["metal1_to_metal1"])
    ...
    def Side_PTX_add_and_create_side_ptx_lima(self):
        ...
        yoffset_side_left=self.gnd_position.y+2.8*self.nmos1.height
        yoffset_side_right=self.gnd_position.y+2.8*self.nmos1.height
        ...
        while (i<=self.no_read_only_port):
            ...
            if (i%2!=0):
                ...
                #R_Row_ptx_origin=xoffset_side_left-drc["minwidth_metal1"]
                ...
                offset=vector(R_Row_ptx_origin_left + self.nmos_ptx.active_contact_positions[0].x,  self.nmos_left_side_position_bar.y-self.nmos1.width-drc["minwidth_metal1"])         
                self.add_inst(name=name_nmos,
                ...
                end= vector(R_Row_ptx_origin_left+self.nmos_R_Row_ptx.active_contact_positions[0].x+self.nmos_R_Row_ptx.active_contact.width,self.nmos_side_position_left.y-self.nmos_ptx.active_contact_positions[1].y)  
                start=vector(R_Row_ptx_origin_left+self.nmos_R_Row_ptx.active_contact_positions[0].x+self.nmos_R_Row_ptx.active_contact.width, self.R_Row_position.y-self.nmos_R_Row_ptx.active_contact.height)
                self.add_path("metal1",[start,end])

                #connect Poly R-Row Ptx
                poly_position_R_Row_ptx=R_Row_ptx_origin_left+self.nmos_R_Row_ptx.poly_positions[0].x+drc["minwidth_poly"]
            ...
            if (i%2==0):
                self.nmos_right_side_position=vector(xoffset_side_right,yoffset_side_right)
                ...
                xoffset_side_right_bar= self.nmos_right_side_position.x+self.nmos_ptx.active_width+self.nmos_ptx.poly_width-self.nmos_ptx.active_contact.width
                self.nmos_right_side_position_bar=vector(xoffset_side_right_bar,yoffset_side_left)
                #self.nmos_side_positions.append(self.nmos_side_position)
                name_nmos = "nmos{0}".format(i+self.side_ptx_start_no+1)
                print(" Creating side Ptx "+ name_nmos)
                self.nmos_ptx= ptx(width=self.nmos_size,
                ...
                R_Row_ptx_origin_right=xoffset_side_right-drc["minwidth_metal1"]
                ...
                """self.add_rect(layer="metal1",
                               offset=vector(R_Row_ptx_origin_right+self.nmos_R_Row_ptx.active_contact_positions[1].x+self.nmos_R_Row_ptx.poly_width*2.2,self.gnd_position.y),
                               width=drc["minwidth_metal1"],
                               height=height)"""
                """#Connect Source of  R-Row ptx to the above side_ptx
                height=(6)*drc["metal1_to_metal1"]
                self.add_rect(layer="metal1",
                               offset=vector(R_Row_ptx_origin_right+self.nmos_R_Row_ptx.active_contact_positions[0].x+self.nmos_R_Row_ptx.active_contact.width*.42,offset.y-self.nmos_R_Row_ptx.active_contact.height),
                               width=drc["minwidth_metal1"],
                               height=height)"""
                ...
                #connect Poly R-Row Ptx
                poly_position_R_Row_ptx=R_Row_ptx_origin_right+self.nmos_R_Row_ptx.poly_positions[0].x+drc["minwidth_poly"]
                ...
                self.add_contact (layers=("poly", "contact", "metal1"),
                                  ...
                                  size=(1,1),
                                  rotate=270)
                """#offset=vector(poly_position_R_Row_ptx+drc["minwidth_metal1"]-drc["minwidth_poly"]*1.2,R_Row_y_bar)
                poly_position_R_Row_ptx=R_Row_ptx_origin_right+self.nmos_R_Row_ptx.poly_positions[0].x+drc["minwidth_metal1"]
    ...
    def extend_rails_lima(self):
        ...
        self.add_label(text="gnd",
                       layer="metal1",
                       offset=self.gnd_position_extended)
